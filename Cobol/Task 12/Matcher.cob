       ...
       EXIT.
           ...
           IF SANCTION-ALIAS-1(SANCTION-INDEX) NOT = "-"
              AND CUSTOMER-NAME(CUSTOMER-INDEX)
                  = SANCTION-ALIAS-1(SANCTION-INDEX)
               ADD 10 TO WORK-ALIAS-SCORE
           END-IF

           IF SANCTION-ALIAS-2(SANCTION-INDEX) NOT = "-"
              AND CUSTOMER-NAME(CUSTOMER-INDEX)
                  = SANCTION-ALIAS-2(SANCTION-INDEX)
               ADD 10 TO WORK-ALIAS-SCORE
           END-IF

           IF SANCTION-ALIAS-3(SANCTION-INDEX) NOT = "-"
              AND CUSTOMER-NAME(CUSTOMER-INDEX)
                  = SANCTION-ALIAS-3(SANCTION-INDEX)
               ADD 10 TO WORK-ALIAS-SCORE
           END-IF

           IF SANCTION-ALIAS-4(SANCTION-INDEX) NOT = "-"
              AND CUSTOMER-NAME(CUSTOMER-INDEX)
                  = SANCTION-ALIAS-4(SANCTION-INDEX)
               ADD 10 TO WORK-ALIAS-SCORE
           END-IF

           IF SANCTION-ALIAS-5(SANCTION-INDEX) NOT = "-"
              AND CUSTOMER-NAME(CUSTOMER-INDEX)
                  = SANCTION-ALIAS-5(SANCTION-INDEX)
               ADD 10 TO WORK-ALIAS-SCORE
           END-IF
