      ...
      *    DISPLAY TRANSACTIONS(TRANSACTION-INDEX)
       ...
       BUILD-CUSTOMER-REPORT.
           ...
           MOVE 0 TO CURRENT-TRANSACTION-INDEX
           ...
           DISPLAY "CPR '" FUNCTION TRIM(CPR 
               OF CUSTOMERS(CUSTOMER-INDEX) TRAILING) "' has '"
                CUSTOMER-TRANSACTIONS-COUNT OF CUSTOMERS(CUSTOMER-INDEX)
                "' transactions."
       ...
       ADD-TRANSACTION-OUTPUT-LINES.
           PERFORM VARYING CUSTOMER-TRANSACTION-INDEX FROM 1 BY 1               
               ...
               DISPLAY "Transactions CPR '" FUNCTION TRIM(CPR                             
                   OF TRANSACTIONS(CURRENT-TRANSACTION-INDEX) TRAILING) 
                   "'."
