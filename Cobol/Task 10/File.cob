       ...
       01 CUSTOMERS OCCURS 25 TIMES.
           ...
           02 DKK-TOTAL-INCOME-DISPLAY PIC -Z,ZZZ,ZZZ,ZZZ,ZZ9.99.
           02 DKK-TOTAL-PAYMENTS PIC S9(11)V99.
           02 DKK-TOTAL-PAYMENTS-DISPLAY PIC -Z,ZZZ,ZZZ,ZZZ,ZZ9.99.
           02 DKK-SALDO PIC S9(11)V99.
           02 DKK-SALDO-DISPLAY PIC -Z,ZZZ,ZZZ,ZZZ,ZZ9.99.
      ...
      *    DISPLAY TRANSACTIONS(TRANSACTION-INDEX)
       ...
       WRITE-CUSTOMER-REPORT-TO-FILE.
           ...
           MOVE SPACES TO OUT-REPORT-RECORD
           WRITE OUT-REPORT-RECORD
